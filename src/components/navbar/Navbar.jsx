...
export default function Nav() {
    ...
    const isAdmin = user && user.role === "admin"; // Adjust `role` based on your database schema
                                ...
                                <Link to={"/dashboard"}>
                                    <div className="">
                                        <Avatar
                                            ...
                                            src={
                                                isAdmin
                                                    ? "https://cdn-icons-png.flaticon.com/128/3135/3135715.png" // Admin icon
                                                    : "https://cdn-icons-png.flaticon.com/128/1177/1177568.png" // Regular user icon
                                            }
                                            alt="avatar"
                                            withBorder={true}
